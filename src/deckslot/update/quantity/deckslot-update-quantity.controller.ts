...
export class DeckslotUpdateQuantityController extends BaseController {
    constructor(
        private deckslotUpdateQuantityUsecase: DeckslotUpdateQuantityUsecase,
    ) {
        super();
    }
    ...
    @Patch(
        "",
        cookieParser(),
        ValidateDTO(IDeckslotUpdateQuantityRequestDto),
    ...
    async execute(
        ...
        return this.callUseCase(
            await this.deckslotUpdateQuantityUsecase.execute(
                payload,
