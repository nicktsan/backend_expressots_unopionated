...
export class DeckslotCreateUsecase {
    ...
    public async execute(
        ...
        IDeckslotCreateResponseDto | IDeckslotFindResponseDto | AppError
    > {
        try {
            ...
            const deckSlotExists: IDeckslotFindResponseDto | null =
                await this.deckSlotRepository.findOneDeckSlot(
