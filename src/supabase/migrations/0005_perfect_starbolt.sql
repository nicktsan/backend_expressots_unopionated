CREATE TABLE IF NOT EXISTS "deckfolder" ("id" uuid PRIMARY KEY NOT NULL,
																																										"name" text NOT NULL,
...
CREATE TABLE IF NOT EXISTS "deck" ("id" uuid PRIMARY KEY NOT NULL,
																																				"name" text NOT NULL,
																																				"creator_id" uuid NOT NULL,
																																				"folder_id" uuid,
																																				"banner" text, "description" text, "views" integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
-- ALTER TABLE "user" DROP CONSTRAINT "user_username_key";--> statement-breakpoint
DO $$ BEGIN
